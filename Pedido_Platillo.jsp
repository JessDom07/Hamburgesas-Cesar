<%-- 
    Document   : Pedido_Platillo
    Created on : 26/11/2024, 09:56:22 PM
    Author     : domin
--%>
...
<body>
  <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
        <h1 align="center"> Tabla Pedido_Platillo </h1>
        <table border="1" width="600" align="center">
            <tr bgcolor="lightsalmon">
                <th colspan="4"> Pedido_Platillo </th>
                <th colspan="2"> <a href="Agregar_Pedido_Platillo.jsp"> <img src="iconos/user.png" width="50"> </a> </th> 
            </tr>
              ...
              <% 
                  ...
                  try{ 
                      Class.forName("com.mysql.jdbc.Driver");
                          ...
                          res=stm.executeQuery("SELECT * FROM t_aux_ped_pla");
                          while(res.next())
                          {
                              %>
                              <tr>
                                  ...
                                  <th> <%=res.getString(4)%> </th>
                                            <th> <a href="Eliminar_Pedido_Platillo.jsp?cod=<%=res.getString(1)%>">
                                                    <img src="iconos/eli.png" width="50"</a> </th>
                                                <th> <a href="Modificar_Pedido_Platillo.jsp?cod=<%=res.getString(1)%>">

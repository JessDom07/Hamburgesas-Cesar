<%-- 
    Document   : Agregar_Pedido_Platillo
    Created on : 28/11/2024, 08:50:43 AM
    Author     : domin
--%>
    ...
    <form align="center">
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Pepl" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "number" name = "Pep_Cant" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>3
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Pepl"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_aux_ped_pla values ("+Clv+", "+cant+","+pedi+","+plat+") ");

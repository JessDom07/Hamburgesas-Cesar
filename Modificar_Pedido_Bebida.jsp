<%-- 
    Document   : Modificar_Pedido_Bebida
    Created on : 28/11/2024, 10:06:58 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
        <h2 align="center"> Modificar Pedido Bebida </h2>
        <%
            ...
            ResultSet res=null;
               try
               {
                ...
                res=stm.executeQuery("select * from t_aux_ped_beb where Clv_Axpb='"+clv+"' ");
         ...
         <form align="center">
    	   <table border="2" align=center>
			<tr>
				<td colspan="3" align=center bgcolor=lightsalmon> Pedido Bebida </td>
			</tr>
			<tr>
				<td>NO.
				</td>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Axpb" min="0" max="100" value="<%=res.getString(1)%>">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "number" name = "Apb_Cant" min="0" max="100" value="<%=res.getString(2)%>">
				</td>
			</tr>
			<tr>
				<td>3
			...
			<tr>
				...
				<td> Clave de la Bebida:
				</td>
				<td>
        				<input type = "number" name ="Clv_Bebi" min="0" max="100" value="<%=res.getString(4)%>">
				</td>
			</tr>
			<tr>
				<td>
...
if (request.getParameter("btnModificar")!=null)
 {
              int cod=Integer.parseInt(request.getParameter("Clv_Axpb"));
              int cant=Integer.parseInt(request.getParameter("Apb_Cant"));
              int pedi=Integer.parseInt(request.getParameter("Clv_Pedi"));
              int bebi=Integer.parseInt(request.getParameter("Clv_Bebi"));

stm.executeUpdate("update t_aux_ped_beb set Apb_Cant="+cant+", Clv_Pedi="+pedi+", Clv_Bebi="+bebi+" where Clv_Axpb="+cod+" ");

<%-- 
    Document   : Pedidos
    Created on : 27/11/2024, 09:00:55 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
        <h1 align="center"> Tabla Pedido </h1>
        <table border="1" width="600" align="center">
            <tr bgcolor="lightsalmon">
                <th colspan="5"> Pedido </th>
                <th colspan="2"> <a href="Agregar_Pedidos.jsp"> <img src="iconos/user.png" width="50"> </a> </th> 
            </tr>
              ...
              <% 
                  ...
                  try{ 
                      Class.forName("com.mysql.jdbc.Driver");
                          ...
                          res=stm.executeQuery("SELECT * FROM t_pedidos");
                          while(res.next())
                          {
                              %>
                              <tr>
                                    ...
                                    <th> <%=res.getString(3)%> </th>
                                     <th> <%=res.getString(4)%> </th>
                                      <th> <%=res.getString(5)%> </th>
                                            <th> <a href="Eliminar_Pedido.jsp?cod=<%=res.getString(1)%>">
                                                    <img src="iconos/eli.png" width="50"</a> </th>
                                                <th> <a href="Modificar_Pedido.jsp?cod=<%=res.getString(1)%>">

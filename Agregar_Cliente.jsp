<%-- 
    ...
    Created on : 27/11/2024, 09:33:22 AM
    Author     : domin
--%>
...
<body>
    ...
    <!-- Page Header End -->
    <form align="center">
    	<h2> Formulario de registros para clientes </h2>
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<h5><td> Apellido Paterno:
				</td></h5>
				<td>
					<input type= "text" name= "Cli_Appa">
				</td>
			</tr>
			<tr>
				<td>4
				</td>
				<h5><td>Apellido Materno:
				</td></h5>
				<td>
        				<input type = "text" name ="Cli_Amma">
				</td>
			</tr>
			<tr>
				<td>5
			...
			<tr>
				...
				<td>
					<input type = "email" name = "Cli_Corr">	
				</td>
			</tr>
			<tr>
				<td>
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Clie"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_clientes values ("+Clv+", '"+nomb+"','"+appa+"', '"+amma+"','"+tele+"', '"+dire+"','"+corr+"') ");

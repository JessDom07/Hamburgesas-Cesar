<%-- 
    Document   : Clientes
    Created on : 26/11/2024, 08:27:26 PM
    Author     : domin
--%>
...
<!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
        <h1 align="center"> Tabla Clientes </h1>
        <table border="1" width="600" align="center">
            <tr bgcolor="lightsalmon">
                <th colspan="7"> Clientes </th>
                <th colspan="2"> <a href="Agregar_Cliente.jsp"> <img src="iconos/user.png" width="50"> </a> </th> 
            </tr>
              ...
              <% 
                  ...
                  try{ 
                      Class.forName("com.mysql.jdbc.Driver");
                          ...
                          res=stm.executeQuery("select * from t_clientes");
                          while(res.next())
                          {
                              %>
                              <tr>
                                      ...
                                      <th> <%=res.getString(5)%> </th>
                                       <th> <%=res.getString(6)%> </th>
                                        <th> <%=res.getString(7)%> </th>
                                            <th> <a href="Eliminar_Cliente.jsp?cod=<%=res.getString(1)%>">
                                                    <img src="iconos/eli.png" width="50"</a> </th>
                                                <th> <a href="Modificar_Cliente.jsp?cod=<%=res.getString(1)%>">

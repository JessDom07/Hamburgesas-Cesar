<%-- 
    Document   : reservar
    Created on : 8/12/2024, 09:02:24 PM
    Author     : domin
--%>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link active dropdown-toggle" data-toggle="dropdown">Atención al Cliente<a>
                    ...
                    <a href="contact.html" class="nav-item nav-link">Contáctanos</a>
                     <a href="Inicio_de_sesion.jsp" class="nav-item nav-link">Administración</a>
                </div>
            </div>
        </nav>
    </div>
            ...
            <div class="reservation position-relative overlay-top overlay-bottom">
                <div class="row align-items-center">
                    <div class="col-lg-6 my-5 my-lg-0">
                        <div class="p-5">
                            <div class="mb-4">
                                <h1 class="text-white">Reservaciones</h1>
                            </div>
                            <p class="text-white">Llena los datos que se te piden a continuación para poder reservar un evento con nosotros</p>
                            <ul class="list-inline text-white m-0">
                                <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Barra abierta durante el evento</li>
                                <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Zona de juegos abierta para los niños</li>
                                <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Decoración a gusto del cliente</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-center p-5">
                            <h1 class="text-white mb-4 mt-5">Has tu reservación</h1>
                            <form class="mb-5">
                                <div class="form-group">
                                    <input type="text" class="form-control  border-primary p-4" placeholder="Nombre"
                                        required="required" />
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control  border-primary p-4" placeholder="Correo"
                                        required="required" />
                                </div>
                                <div class="form-group">
                                    <div class="date" id="date" data-target-input="nearest">
                                        <input type="text" class="form-control  border-primary p-4 datetimepicker-input" placeholder="Fecha" data-target="#date" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="time" id="time" data-target-input="nearest">
                                        <input type="text" class="form-control  border-primary p-4 datetimepicker-input" placeholder="Hora" data-target="#time" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <select class="custom-select  border-primary px-4" style="height: 49px;">
                                        ...
                                        <option value="2">10 personas</option>
                                        <option value="3">15 personas</option>
                                        <option value="3">20 personas</option>
                                    </select>
                                </div>
                                
                                <div>
                                    <button class="btn btn-primary btn-block font-weight-bold py-3" type="submit">Hacer reservación</button>
                                </div>
                            </form>
                        </div>
                    </div>

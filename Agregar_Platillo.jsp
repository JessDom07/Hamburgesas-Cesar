<%-- 
    Document   : Agregar_Platillo
    Created on : 27/11/2024, 09:42:28 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
    	<h2> Formulario de registros para platillos </h2>
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Plat" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>2
			...
			<tr>
				...
				<td>
        				<input type = "float" name ="Pla_Prec">
				</td>
			</tr>
			<tr>
				<td>5
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Plat"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_platillo values ("+Clv+", '"+nomb+"','"+desc+"', "+prec+", '"+cate+"') ");

<%-- 
    ...
    Created on : 28/11/2024, 09:09:40 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
        <h2 align="center"> Modificar Clientes </h2>
        <%
            ...
            ResultSet res=null;
               try
               {
                ...
                res=stm.executeQuery("select * from t_clientes where Clv_Clie='"+clv+"' ");
    	 ...
    	 <table border="2" align=center>
			<tr>
				<td colspan="3" align=center bgcolor=lightsalmon> Clientes </td>
			</tr>
			<tr>
				<td>NO.
				</td>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Clie" min="0" max="100" value="<%=res.getString(1)%>">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "text" name = "Cli_Nomb" value="<%=res.getString(2)%>">
				</td>
			</tr>
			<tr>
				<td>3
				...
				<td>
					<input type= "text" name= "Cli_Appa" value="<%=res.getString(3)%>">
				</td>
			</tr>
			<tr>
				<td>4
				...
				<td>
        				<input type = "text" name ="Cli_Amma" value="<%=res.getString(4)%>">
				</td>
			</tr>
			<tr>
				<td>5
				...
				<td>
					<input type= "text" name= "Cli_Tele" value="<%=res.getString(5)%>">
				</td>
			</tr>	
			<tr>
				<td>6
				...
				<td>
        				<input type = "text" name = "Cli_Dire" value="<%=res.getString(6)%>">
				</td>
			</tr>
			<tr>
				<td>7
				...
				<td>
					<input type = "email" name = "Cli_Corr" value="<%=res.getString(7)%>">	
				</td>
			</tr>
			<tr>
				<td>
...
if (request.getParameter("btnModificar")!=null)
 {
              int cod=Integer.parseInt(request.getParameter("Clv_Clie"));
              String nomb=request.getParameter("Cli_Nomb");
              String appa=request.getParameter("Cli_Appa");
              String amma=request.getParameter("Cli_Amma");
              String tele=request.getParameter("Cli_Tele");
              String dire=request.getParameter("Cli_Dire");
              String corr=request.getParameter("Cli_Corr");    

stm.executeUpdate("update t_clientes set Cli_Nomb='"+nomb+"', Cli_Appa='"+appa+"', Cli_Amma='"+amma+"', Cli_Tele='"+tele+"', Cli_Dire='"+dire+"', Cli_Corr='"+corr+"' where Clv_Clie="+cod+" ");

<%-- 
    Document   : Modificar_Reservacion
    Created on : 28/11/2024, 09:45:57 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
        <h2 align="center"> Modificar Reservación </h2>
        <%
            ...
            ResultSet res=null;
               try
               {
                ...
                res=stm.executeQuery("select * from t_reservaciones where Clv_Rese='"+clv+"' ");
         ...
         <form align="center">
			...
			<tr>
				<td colspan="3" align=center bgcolor=lightsalmon> Reservaciones </td>
			</tr>
			<tr>
				<td>NO.
				</td>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Rese" min="0" max="100" value="<%=res.getString(1)%>">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "number" name = "Clv_Clie" min="0" max="100" value="<%=res.getString(2)%>">
				</td>
			</tr>
			<tr>
				<td>3
				...
				<td>
					<input type= "date" name= "Res_Fech" value="<%=res.getString(3)%>">
				</td>
			</tr>
			<tr>
				<td>4
				...
				<td>
        				<input type = "time" name ="Res_Hora" value="<%=res.getString(4)%>">
				</td>
			</tr>
			<tr>
				<td>5
				...
				<td>
					<input type = "number" name = "Res_Nope" min="0" max="100" value="<%=res.getString(5)%>">	
				</td>
			</tr>
			<tr>
				<td>
...
if (request.getParameter("btnModificar")!=null)
 {
            int cod=Integer.parseInt(request.getParameter("Clv_Rese"));
...
stm.executeUpdate("update t_reservaciones set Clv_Clie="+clie+", Res_Fech='"+fech+"', Res_Hora='"+hora+"', Res_Nope="+pers+" where Clv_Rese="+cod+" ");

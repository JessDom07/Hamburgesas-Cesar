<%-- 
    Document   : Modificar_Platillo
    Created on : 28/11/2024, 09:32:46 AM
    Author     : domin
--%>
...
<body>
    ...
    <!-- Page Header End -->
        <h2 align="center"> Modificar Platillo </h2>
        <%
            ...
            ResultSet res=null;
               try
               {
                ...
                res=stm.executeQuery("select * from t_platillo where Clv_Plat='"+clv+"' ");
    	 ...
    	 <table border="2" align=center>
			<tr>
				<td colspan="3" align=center bgcolor=lightsalmon> Platillos </td>
			</tr>
			<tr>
				<td>NO.
				</td>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Plat" min="0" max="100" value="<%=res.getString(1)%>">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "text" name = "Pla_Nomb" value="<%=res.getString(2)%>">
				</td>
			</tr>
			<tr>
				<td>3
				...
				<td>
					<input type= "text" name= "Pla_Desc" value="<%=res.getString(3)%>">
				</td>
			</tr>
			<tr>
				<td>4
				...
				<td>
        				<input type = "float" name ="Pla_Prec" value="<%=res.getString(4)%>">
				</td>
			</tr>
			<tr>
				<td>5
				...
				<td>
					<input type = "text" name = "Pla_Cate" value="<%=res.getString(5)%>">	
				</td>
			</tr>
			<tr>
				<td>
...
if (request.getParameter("btnModificar")!=null)
 {
             int cod=Integer.parseInt(request.getParameter("Clv_Plat"));
              String nomb=request.getParameter("Pla_Nomb");
              String desc=request.getParameter("Pla_Desc");
              double prec=Double.parseDouble(request.getParameter("Pla_Prec"));
              String cate=request.getParameter("Pla_Cate");

stm.executeUpdate("update t_platillo set Pla_Nomb='"+nomb+"', Pla_Desc='"+desc+"', Pla_Prec="+prec+", Pla_Cate='"+cate+"' where Clv_Plat="+cod+" ");

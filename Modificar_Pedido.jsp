<%-- 
    Document   : Modificar_Pedido
    Created on : 28/11/2024, 09:55:59 AM
    Author     : domin
--%>
...
<body>
  <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
        <h2 align="center"> Modificar Pedido </h2>
        <%
            ...
            ResultSet res=null;
               try
               {
                ...
                res=stm.executeQuery("select * from t_pedidos where Clv_Pedi='"+clv+"' ");
    	 ...
    	 <table border="2" align=center>
			<tr>
				<td colspan="3" align=center bgcolor=lightsalmon> Pedidos </td>
			</tr>
			<tr>
				<td>NO.
				</td>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Pedi" min="0" max="100" value="<%=res.getString(1)%>">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "date" name = "Ped_Fech" value="<%=res.getString(2)%>">
				</td>
			</tr>
			<tr>
				<td>3
				...
				<td>
					<input type= "time" name= "Ped_Hora" value="<%=res.getString(3)%>">
				</td>
			</tr>
			<tr>
				<td>4
				...
				<td>
        				<input type = "float" name ="Ped_Tota" value="<%=res.getString(4)%>">
				</td>
			</tr>
			<tr>
				<td>5
				...
				<td>
					<input type = "number" name = "Clv_Clie" min="0" max="100" value="<%=res.getString(5)%>">	
				</td>
			</tr>
			<tr>
				<td>
...
if (request.getParameter("btnModificar")!=null)
 {
              int cod=Integer.parseInt(request.getParameter("Clv_Pedi"));
              String fech=request.getParameter("Ped_Fech");
              String hora=request.getParameter("Ped_Hora");
              double tota=Double.parseDouble(request.getParameter("Ped_Tota"));
              int clie=Integer.parseInt(request.getParameter("Clv_Clie"));

stm.executeUpdate("update t_pedidos set Ped_Fech='"+fech+"', Ped_Hora='"+hora+"', Ped_Tota="+tota+", Clv_Clie="+clie+" where Clv_Pedi="+cod+" ");

<%-- 
    Document   : Agregar_Pedido_Bebida
    Created on : 27/11/2024, 10:27:34 AM
    Author     : domin
--%>
    ...
    <form align="center">
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Axpb" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "number" name = "Apb_Cant" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>3
				</td>
				 <h5><td>Clave del Pedido:
				</td> </h5>
				<td>
					<input type= "number" name= "Clv_Pedi" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>4
				</td>
				 <h5><td> Clave de la Bebida:
				</td></h5>
				<td>
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Axpb"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_aux_ped_beb values ("+Clv+", "+cant+","+pedi+","+bebi+") ");

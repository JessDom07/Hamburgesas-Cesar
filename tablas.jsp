<%-- 
    Document   : tablas
    Created on : 1/12/2024, 11:25:26 PM
    Author     : domin
--%>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h1 class="text-uppercase" style="letter-spacing: 5px;">¡Bienvenido Administrador!</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/empleado.jpg" alt="">
                        <h2 align="center"> <a href="Empleados.jsp" class="nav-item nav-link"> Empleados </a> </h2>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/cliente.jpg" alt="">
                        <h2 align="center"> <a href="Clientes.jsp" class="nav-item nav-link"> Clientes </a> </h2>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/platillo.jpg" alt="">
                        <h2 align="center"> <a href="Platillos.jsp" class="nav-item nav-link"> Platillo </a> </h2>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/bebida.jpg" alt="">
                        <h2 align="center"> <a href="Bebidas.jsp" class="nav-item nav-link"> Bebidas </a> </h2>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/pedido.jpg" alt="">
                        <h2 align="center"> <a href="Pedidos.jsp" class="nav-item nav-link"> Pedidos </a> </h2>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/reservacion.jpg" alt="">
                        <h2 align="center"> <a href="Reservacion.jsp" class="nav-item nav-link"> Reservaciones </a> </h2>
                    </div>
                </div>
                 <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/pedido_bebida.jpg" alt="">
                        <h2 align="center"> <a href="Pedido_Bebida.jsp" class="nav-item nav-link"> Pedido & Bebida </a> </h2>
                    </div>
                </div>
                 <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/pedido_platillo.jpg" alt="">
                        <h2 align="center"> <a href="Pedido_Platillo.jsp" class="nav-item nav-link"> Pedido & Platillo </a> </h2>
                    </div>
                </div>
            </div>
        </div>

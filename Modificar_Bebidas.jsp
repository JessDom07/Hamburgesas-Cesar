<%-- 
    Document   : Modificar_Bebidas
    Created on : 28/11/2024, 09:22:17 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
        <h2 align="center"> Modificar Bebidas </h2>
        <%
            ...
            ResultSet res=null;
               try
               {
                ...
                res=stm.executeQuery("select * from t_bebidas where Clv_Bebi='"+clv+"' ");
    	 ...
    	 <table border="2" align=center>
			<tr>
				<td colspan="3" align=center bgcolor=lightsalmon> Bebidas </td>
			</tr>
			<tr>
				<td>NO.
				</td>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Bebi" min="0" max="100" value="<%=res.getString(1)%>">
				</td>
			</tr>
			<tr>
				<td>2
				...
				<td>
					<input type = "text" name = "Beb_Nomb" value="<%=res.getString(2)%>">
				</td>
			</tr>
			<tr>
				<td>3
				...
				<td>
					<input type= "float" name= "Beb_Prec" value="<%=res.getString(3)%>">
				</td>
			</tr>
			<tr>
				<td>4
				...
				<td>
        				<input type = "text" name ="Beb_Desc" value="<%=res.getString(4)%>">
				</td>
			</tr>
			<tr>
				<td>5
				...
				<td>
					<input type = "number" name = "Beb_Cant" min="0" max="100" value="<%=res.getString(5)%>">	
				</td>
			</tr>
                        <tr>
				<td>6
				</td>
				<td> Fecha de Caducidad:
				</td>
				<td>
					<input type = "date" name = "Beb_Cadu" value="<%=res.getString(6)%>">	
				</td>
			</tr>
			<tr align="center">
				<td>
...
if (request.getParameter("btnModificar")!=null)
 {
              int cod=Integer.parseInt(request.getParameter("Clv_Bebi"));
              String nomb=request.getParameter("Beb_Nomb");
              double prec=Double.parseDouble(request.getParameter("Beb_Prec"));
              String desc=request.getParameter("Beb_Desc");
              int cant=Integer.parseInt(request.getParameter("Beb_Cant"));
              String cadu=request.getParameter("Beb_Cadu");

stm.executeUpdate("update t_bebidas set Beb_Nomb='"+nomb+"', Beb_Prec="+prec+", Beb_Desc='"+desc+"', Beb_Cant="+cant+", Beb_Cadu='"+cadu+"' where Clv_Bebi="+cod+" ");
 request.getRequestDispatcher("Bebidas.jsp").forward(request, response);
}
%>
   <!-- Footer Start -->

<%-- 
    Document   : Agregar_Empleado
    Created on : 27/11/2024, 09:12:46 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
    	<h2> Formulario de registros para empleados </h2>
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Empl" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>2
			...
			<tr>
				...
				<td>
					<input type= "email" name= "Emp_Corr">
				</td>
			</tr>	
                        <tr>
				<td>7
				...
				<td>
                        		<input type= "text" name= "Emp_Pues">
				</td>
			</tr>
			<tr>
				<td>8
				</td>
				<h5><td>Hora de Entrada:
				</td></h5>
				<td>
					<input type = "time" name = "Emp_Hore">
				</td>
			</tr>
			<tr>
				<td>9
				</td>
				<h5><td>Hora de Salida:
				</td></h5>
				<td>
					<input type= "time" name= "Emp_Hors">
				</td>
			</tr>
			<tr>
				<td>10
			...
			<tr>
				...
				<td>
					<input type = "float" name = "Emp_Suel" >	
				</td>
			</tr>
			<tr>
				<td>
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Empl"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_empleados values ("+Clv+", '"+nomb+"','"+appa+"', '"+amma+"', '"+tele+"', '"+corr+"', '"+pues+"','"+hore+"', '"+hors+"', '"+dire+"', "+suel+") ");

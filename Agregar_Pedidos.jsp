<%-- 
    Document   : Agregar_Pedidos
    Created on : 27/11/2024, 10:07:40 AM
    Author     : domin
--%>
...
<body>
    ...
    <!-- Page Header End -->
    <form align="center">
    	<h2> Formulario de registros para pedidos </h2>
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<td>
        				<input type = "float" name ="Ped_Tota">
				</td>
			</tr>
			<tr>
				<td>5
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Pedi"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_pedidos values ("+Clv+", '"+fech+"','"+hora+"', "+tota+", "+clie+") ");

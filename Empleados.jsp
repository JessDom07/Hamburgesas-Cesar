<%-- 
    Document   : Empleados
    Created on : 26/11/2024, 08:10:31 PM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
        <h1 align="center"> Tabla Empleado </h1>
        <table border="1" width="600" align="center">
            <tr bgcolor="lightsalmon">
                <th colspan="11"> Empleado </th>
                <th colspan="2"> <a href="Agregar_Empleado.jsp"> <img src="iconos/user.png" width="50"> </a> </th> 
            </tr>
              ...
              <% 
                  ...
                  try{ 
                      Class.forName("com.mysql.jdbc.Driver");
                          ...
                          res=stm.executeQuery("select * from t_empleados");
                          while(res.next())
                          {
                              %>
                              <tr>
                                       ...
                                       <th> <%=res.getString(6)%> </th>
                                        <th> <%=res.getString(7)%> </th>
                                         <th> <%=res.getString(8)%> </th>
                                          <th> <%=res.getString(9)%> </th>
                                           <th> <%=res.getString(10)%> </th>
                                            <th> <%=res.getString(11)%> </th>
                                            <th> <a href="Eliminar_Empleado.jsp?cod=<%=res.getString(1)%>">
                                                    <img src="iconos/eli.png" width="50"</a> </th>
                                                <th> <a href="Modificar_Empleado.jsp?cod=<%=res.getString(1)%>">

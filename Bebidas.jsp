<%-- 
    Document   : Bebidas
    Created on : 26/11/2024, 09:11:22 PM
    Author     : domin
--%>
...
<body>
    ...
    <!-- Page Header End -->
    <form align="center">
        <h1 align="center"> Tabla Bebidas </h1>
        <table border="1" width="600" align="center">
            <tr bgcolor="lightsalmon">
                <th colspan="6"> Bebidas </th>
                <th colspan="2"> <a href="Agregar_Bebida.jsp"> <img src="iconos/user.png" width="50"> </a> </th> 
            </tr>
              ...
              <% 
                  ...
                  try{ 
                      Class.forName("com.mysql.jdbc.Driver");
                          ...
                          res=stm.executeQuery("select * from t_bebidas");
                          while(res.next())
                          {
                              %>
                              <tr>
                                     ...
                                     <th> <%=res.getString(4)%> </th>
                                      <th> <%=res.getString(5)%> </th>
                                       <th> <%=res.getString(6)%> </th>
                                            <th> <a href="Eliminar_Bebida.jsp?cod=<%=res.getString(1)%>">
                                                    <img src="iconos/eli.png" width="50"</a> </th>
                                                <th> <a href="Modificar_Bebidas.jsp?cod=<%=res.getString(1)%>">

<%-- 
    Document   : Agregar_Bebida
    Created on : 27/11/2024, 09:56:09 AM
    Author     : domin
--%>
...
<body>
   <!-- Navbar Start -->
    ...
    <!-- Page Header End -->
    <form align="center">
    	<h2> Formulario de registros para bebidas </h2>
    	<h3> Ingrese los datos que se piden a continuación </h3>
			...
			<tr>
				...
				<td>
                        		<input type= "number" name= "Clv_Bebi" min="0" max="100">
				</td>
			</tr>
			<tr>
				<td>2
			...
			<tr>
				...
				<td>
					<input type= "float" name= "Beb_Prec">
				</td>
			</tr>
			<tr>
				<td>4
			...
			<tr>
				...
				<td>
					<input type = "number" name = "Beb_Cant" min="0" max="100">	
				</td>
			</tr>
                        <tr>
				<td>6
				</td>
				<h5><td> Fecha de Caducidad:
				</td> </h5>
				<td>
					<input type = "date" name = "Beb_Cadu">	
				</td>
			</tr>
			<tr>
				<td>
        ...
        <%
            ...
            {
              int Clv=Integer.parseInt(request.getParameter("Clv_Bebi"));
              ...
              try{
                  ...
                  sta.executeUpdate("insert into t_bebidas values ("+Clv+", '"+nomb+"', "+prec+", '"+desc+"', "+cant+", '"+cadu+"') ");
